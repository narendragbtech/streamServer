...
io.on('connection', function (socket) {
    ...
    //  getImage('rtsp://admin:ADMIN@12@136.233.89.172:1024/Streaming/Channels/401','./public/picture-'+number+'.jpg', (type,object)=>{
    //      console.log('execution',type);
    //      if(type ===2){
    //          let code = cams.map(i => i.channel);
    //            fs.readFile(__dirname+"/public/picture-"+number+".jpg",(err,data)=>{
    //                if(!err){
    //                    console.log(data);
